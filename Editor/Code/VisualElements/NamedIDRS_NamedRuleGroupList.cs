...
namespace MSU.Editor.VisualElements
{
    public class NamedIDRS_NamedRuleGroupList : VisualElement
    {
        ...
        public void CheckForNamedIDRS(SerializedObject serializedObject)
        {
            ...
            if (_serializedObject.targetObject is NamedItemDisplayRuleSet)
            {
                this.SetDisplay(idrs);
                ExtendedListView.collectionProperty = serializedObject.FindProperty("rules");
            }
        }
        ...
        private void SortEntries()
        {
            ...
            NamedItemDisplayRuleSet namedIDRS = (NamedItemDisplayRuleSet)_serializedObject.targetObject;
